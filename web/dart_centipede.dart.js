...
$$.Rect = {"": "Object;left>,top>,width>,height>",
  ...
  $eq: function(_, other) {
    ...
    return this.left === t1.get$left(other) && this.top === t1.get$top(other) && this.width === t1.get$width(other) && this.height === t1.get$height(other);
  },
  round$0: function(_) {
    return $.Rect$($.JSNumber_methods.round$0(this.left), $.JSNumber_methods.round$0(this.top), $.JSNumber_methods.round$0(this.width), $.JSNumber_methods.round$0(this.height));
  },
  toInt$0: function(_) {
    return $.Rect$($.JSNumber_methods.toInt$0(this.left), $.JSNumber_methods.toInt$0(this.top), $.JSNumber_methods.toInt$0(this.width), $.JSNumber_methods.toInt$0(this.height));
  },
  $isRect: true,
  $asRect: null
};
...
$$.Game = {"": "Object;canvas,renderTime,_width,_height,mx,my,max_cells,body,current_food,game_timer,direction,game_running,game_success,head,speed,cell_size,fill,growth_rate,growth_remaining,direction_time,next_direction",
  init_var$0: function() {
    var t1, t2, max;
    t1 = this.canvas;
    t2 = $.getInterceptor$x(t1);
    this._width = t2.get$width(t1);
    this._height = t2.get$height(t1);
    this.cell_size = 8;
    this.speed = 100;
    this.max_cells = [$.JSNumber_methods.toInt$0($.$div$n(this._width, this.cell_size)), $.JSNumber_methods.toInt$0($.$div$n(this._height, this.cell_size))];
    t1 = this._width;
    t2 = this.cell_size;
    this.head = $.Cell$($.$div$n(t1, t2) / 2, $.$div$n(this._height, t2) / 2, t2);
    this.body = [this.head];
    this.growth_rate = 4;
    this.growth_remaining = 0;
    this.direction_time = 0;
    max = 4;
    switch (Math.random() * max >>> 0) {
      case 0:
  ...
  mouse_movement$1: function(e) {
    ...
    t1 = this.mx;
    t2 = this.my;
    document.querySelector("#mouse").textContent = "(" + $.S($.toInt$0$nx($.round$0$nx(t1))) + "," + $.S($.toInt$0$nx($.round$0$nx(t2))) + ")";
  },
  get$mouse_movement: function() {
    return new $.BoundClosure$1(this, "mouse_movement$1");
  },
  mouse_press$1: function(e) {
    var context, t1, t2, t3, t4;
    ...
    if (this.game_running !== true) {
      ...
      if (t4.$gt(t1, t3.$div(t2, 4) + 4) && t4.$lt(t1, t3.$div(t2, 4) + 4 + t3.$div(t2, 2) - 8) && $.$gt$n(this.my, $.$div$n($.$mul$n(this._height, 5), 12) + 8) && $.$lt$n(this.my, $.$div$n($.$mul$n(this._height, 5), 12) + 4 + $.$div$n(this._height, 4) - 16)) {
        $.Primitives_printString("Button Pressed");
        ...
        if (t1 === true) {
          ...
          context.clearRect(t1.$div(t2, 4), t4.$div(t3, 6), t1.$div(t2, 2), t4.$div(t3, 2));
          context.fillRect($.$div$n(this._width, 4) + 4, $.$div$n($.$mul$n(this._height, 5), 12) + 4, $.$div$n(this._width, 2) - 8, $.$div$n(this._height, 4) - 8);
          context.clearRect($.$div$n(this._width, 4) + 10, $.$div$n($.$mul$n(this._height, 5), 12) + 10, $.$div$n(this._width, 2) - 20, $.$div$n(this._height, 4) - 20);
          context.font = "30pt Calibri";
          context.textAlign = "center";
          t3 = this._width;
          t4 = $.getInterceptor$n(t3);
          context.fillText("Success", t4.$div(t3, 2), $.$div$n(this._height, 4), t4.$div(t3, 2));
          context.font = "20pt Calibri";
          context.textAlign = "center";
          t3 = this._width;
          t4 = $.getInterceptor$n(t3);
          context.fillText("New Game", t4.$div(t3, 2), $.$div$n(this._height, 2) + 4, t4.$div(t3, 2));
        } else {
          t1 = $.getInterceptor$n(t2);
          t4 = $.getInterceptor$n(t3);
          context.clearRect(t1.$div(t2, 4), t4.$div(t3, 6), t1.$div(t2, 2), t4.$div(t3, 2));
          ...
          t3 = this._width;
          t4 = $.getInterceptor$n(t3);
          context.fillText("Failure", t4.$div(t3, 2), $.$div$n(this._height, 4), t4.$div(t3, 2));
          context.font = "20pt Calibri";
          context.textAlign = "center";
          t3 = this._width;
          t4 = $.getInterceptor$n(t3);
          context.fillText("Restart", t4.$div(t3, 2), $.$div$n(this._height, 2) + 4, t4.$div(t3, 2));
        }
      }
    }
  },
  get$mouse_press: function() {
    return new $.BoundClosure$1(this, "mouse_press$1");
  },
  mouse_release$1: function(e) {
    var t1, t2, context, t3, t4, t5, t6;
    t1 = this.canvas;
    t2 = $.getInterceptor$x(t1);
    ...
    if (this.game_running !== true) {
      ...
      t6 = $.getInterceptor$n(t3);
      if (t6.$gt(t3, t5.$div(t4, 4) + 4) && t6.$lt(t3, t5.$div(t4, 4) + 4 + t5.$div(t4, 2) - 8) && $.$gt$n(this.my, $.$div$n($.$mul$n(this._height, 5), 12) + 8) && $.$lt$n(this.my, $.$div$n($.$mul$n(this._height, 5), 12) + 4 + $.$div$n(this._height, 4) - 16)) {
        $.Primitives_printString("Button Released");
        t3 = this.game_success;
        t4 = this._width;
        t5 = this._height;
        if (t3 === true) {
          t3 = $.getInterceptor$n(t4);
          t6 = $.getInterceptor$n(t5);
          context.clearRect(t3.$div(t4, 4), t6.$div(t5, 6), t3.$div(t4, 2), t6.$div(t5, 2));
          context.fillRect($.$div$n(this._width, 4) + 4, $.$div$n($.$mul$n(this._height, 5), 12) + 4, $.$div$n(this._width, 2) - 8, $.$div$n(this._height, 4) - 8);
          context.clearRect($.$div$n(this._width, 4) + 8, $.$div$n($.$mul$n(this._height, 5), 12) + 8, $.$div$n(this._width, 2) - 16, $.$div$n(this._height, 4) - 16);
          context.font = "30pt Calibri";
          context.textAlign = "center";
          t5 = this._width;
          t6 = $.getInterceptor$n(t5);
          context.fillText("Success", t6.$div(t5, 2), $.$div$n(this._height, 4), t6.$div(t5, 2));
          context.font = "20pt Calibri";
          context.textAlign = "center";
          t5 = this._width;
          t6 = $.getInterceptor$n(t5);
          context.fillText("New Game", t6.$div(t5, 2), $.$div$n(this._height, 2), t6.$div(t5, 2));
        } else {
          t3 = $.getInterceptor$n(t4);
          t6 = $.getInterceptor$n(t5);
          context.clearRect(t3.$div(t4, 4), t6.$div(t5, 6), t3.$div(t4, 2), t6.$div(t5, 2));
          ...
          t5 = this._width;
          t6 = $.getInterceptor$n(t5);
          context.fillText("Failure", t6.$div(t5, 2), $.$div$n(this._height, 4), t6.$div(t5, 2));
          context.font = "20pt Calibri";
          context.textAlign = "center";
          t5 = this._width;
          t6 = $.getInterceptor$n(t5);
          context.fillText("Restart", t6.$div(t5, 2), $.$div$n(this._height, 2), t6.$div(t5, 2));
        }
        this.init_var$0();
        context = t2.get$context2D(t1);
  ...
  get$mouse_release: function() {
    return new $.BoundClosure$1(this, "mouse_release$1");
  },
  getMouse$1: function(e) {
    var t1, t2;
    t1 = $.getInterceptor$x(e);
    t2 = this.canvas;
    this.mx = $.$sub$n($.$add$ns(this._width, t1.get$clientX(e)), $.get$right$x(t2.getBoundingClientRect()));
  ...
  get$key_listener: function() {
    return new $.BoundClosure$1(this, "key_listener$1");
  },
  get_next_food$0: function() {
    ...
    if (t1.$gt(max, 4294967295))
      max = 4294967295;
    this.current_food = $.Food$(first, Math.random() * max >>> 0, this.cell_size);
  },
  step$0: function(_) {
    var t1, t2, next_position, t3, t4, i, milliseconds;
    t1 = this.direction_time;
    if (typeof t1 !== "number")
      throw t1.$gt();
    if (t1 > 0)
      this.direction_time = t1 - 1;
    if (this.direction_time === 0) {
    ...
    next_position = $.Cell$nextPosition(this.head, this.direction);
    t1 = next_position.x;
    if (typeof t1 !== "number")
      return this.step$0$bailout(1, next_position, t1);
    t2 = this.max_cells;
    t3 = t2.length;
    if (0 >= t3)
      throw $.ioore(0);
    t4 = t2[0];
    if (typeof t4 !== "number")
      return this.step$0$bailout(2, next_position, t1, t4);
    if (!(t1 > t4 - 1)) {
      t4 = next_position.y;
      if (typeof t4 !== "number")
        return this.step$0$bailout(3, next_position, t4);
      if (1 >= t3)
        throw $.ioore(1);
      t2 = t2[1];
      if (typeof t2 !== "number")
        return this.step$0$bailout(4, next_position, t4, t2);
      t1 = t4 > t2 - 1 || t1 < 0 || t4 < 0;
    } else
      t1 = true;
    if (t1)
      this.game_over$0();
    ...
    if (t1.compareTo$1(t1, next_position) === 0) {
      ...
      t2 = this.growth_rate;
      if (t2 !== (t2 | 0))
        return this.step$0$bailout(7, next_position, t1, t2);
      if (typeof t1 !== "number")
        throw t1.$add();
    ...
    if (typeof t1 !== "number")
      throw t1.$lt();
    if (t1 < 1)
      $.removeLast$0$ax(this.body);
    else
      this.growth_remaining = t1 - 1;
    for (i = 0; t1 = this.body, i < t1.length; ++i)
      if (next_position.equal$1(t1[i]))
        this.game_over$0();
    $.insert$2$ax(t1, 0, next_position);
    t1 = this.body;
    if (0 >= t1.length)
      throw $.ioore(0);
    this.head = t1[0];
    if (this.game_running === true) {
      t1 = $.Duration$(0, 0, 0, this.speed, 0, 0);
      t2 = this.get$step(this);
      milliseconds = t1.get$inMilliseconds();
      if (milliseconds < 0)
        milliseconds = 0;
      this.game_timer = $.TimerImpl$(milliseconds, t2);
    }
  },
  step$0$bailout: function(state0, next_position, t1, t2) {
    switch (state0) {
      case 0:
        t1 = this.direction_time;
        ...
        if (typeof t1 !== "number")
          throw t1.$gt();
        if (t2.$gt(t1, 0))
          this.direction_time = t2.$sub(t1, 1);
        if (this.direction_time === 0) {
          t1 = this.next_direction;
          t2 = this.direction;
          t2 = t1 == null ? t2 != null : t1 !== t2;
      ...
      case 2:
        state0 = 0;
      default:
        if (state0 === 6 || state0 === 5 || state0 === 4 || state0 === 3 || state0 === 0 && !$.$gt$n(t1, $.$sub$n(t2, 1)))
          switch (state0) {
            case 0:
              t1 = next_position.y;
            case 3:
            ...
            case 4:
              state0 = 0;
            default:
              if (state0 === 6 || state0 === 5 || state0 === 0 && !$.$gt$n(t1, $.$sub$n(t2, 1)))
                switch (state0) {
                  case 0:
                    t1 = next_position.x;
                  case 5:
                    state0 = 0;
                  case 6:
                    if (state0 === 6 || state0 === 0 && !$.$lt$n(t1, 0))
                      switch (state0) {
                        case 0:
                          t1 = next_position.y;
                        case 6:
      ...
      case 7:
        var i, milliseconds;
        if (state0 === 7 || state0 === 0 && t1.compareTo$1(t1, next_position) === 0)
          switch (state0) {
            case 0:
              t1 = this.growth_remaining;
              t2 = this.growth_rate;
            case 7:
              ...
              if (typeof t1 !== "number")
                throw t1.$add();
              this.growth_remaining = $.$add$ns(t1, t2);
              this.get_next_food$0();
          }
        t1 = this.growth_remaining;
        t2 = $.getInterceptor$n(t1);
        ...
        if (t2.$lt(t1, 1))
          ...
          this.growth_remaining = t2.$sub(t1, 1);
        for (i = 0; t1 = this.body, i < t1.length; ++i)
          if (next_position.equal$1(t1[i]))
            this.game_over$0();
        $.insert$2$ax(t1, 0, next_position);
  ...
  get$step: function(receiver) {
    return new $.BoundClosure$i0(this, "step$0", receiver);
  },
  game_over$0: function() {
    ...
    t4 = t2[0];
    if (typeof t4 !== "number")
      return this.game_over$0$bailout(1, t2, t4, t1, t3);
    if (1 >= t3)
      throw $.ioore(1);
    t2 = t2[1];
    if (typeof t2 !== "number")
      return this.game_over$0$bailout(2, t2, t4, t1);
    $.Primitives_printString(t1 + $.S($.JSNumber_methods.toInt$0(t4 * t2 / 2)));
    ...
    t3 = t4[0];
    if (typeof t3 !== "number")
      return this.game_over$0$bailout(3, t2, t4, t1, t3);
    if (1 >= t1)
      throw $.ioore(1);
    t4 = t4[1];
    if (typeof t4 !== "number")
      return this.game_over$0$bailout(4, t2, t4, 0, t3);
    this.game_success = t2 > t3 * t4 / 2;
    t1 = this.game_success;
    t2 = this.speed;
    if (t1 === true) {
      t1 = $.Duration$(0, 0, 0, t2, 0, 0);
      t2 = this.get$draw_success();
      milliseconds = t1.get$inMilliseconds();
      if (milliseconds < 0)
        milliseconds = 0;
      this.game_timer = $.TimerImpl$(milliseconds, t2);
  ...
  game_over$0$bailout: function(state0, t2, t4, t1, t3) {
    switch (state0) {
      case 0:
        t1 = "You had " + this.body.length + "/";
        t2 = this.max_cells;
      ...
      case 2:
        state0 = 0;
        $.Primitives_printString(t1 + $.S($.JSNumber_methods.toInt$0($.$div$n($.$mul$n(t4, t2), 2))));
        this.game_running = false;
        t2 = this.body.length;
        t4 = this.max_cells;
        t1 = t4.length;
      ...
      case 4:
        var milliseconds;
        state0 = 0;
        this.game_success = t2 > $.$div$n($.$mul$n(t3, t4), 2);
        t1 = this.game_success;
        t2 = this.speed;
        if (t1 === true) {
          t1 = $.Duration$(0, 0, 0, t2, 0, 0);
  ...
  draw_failure$0: function() {
    ...
    t4 = this._height;
    t5 = $.getInterceptor$n(t4);
    context.clearRect(t3, t5.$div(t4, 6), t2.$div(t1, 2), t5.$div(t4, 2));
    context.fillRect($.$div$n(this._width, 4) + 4, $.$div$n($.$mul$n(this._height, 5), 12) + 4, $.$div$n(this._width, 2) - 8, $.$div$n(this._height, 4) - 8);
    context.clearRect($.$div$n(this._width, 4) + 8, $.$div$n($.$mul$n(this._height, 5), 12) + 8, $.$div$n(this._width, 2) - 16, $.$div$n(this._height, 4) - 16);
    context.font = "30pt Calibri";
    context.textAlign = "center";
    t4 = this._width;
    t5 = $.getInterceptor$n(t4);
    context.fillText("Failure", t5.$div(t4, 2), $.$div$n(this._height, 4), t5.$div(t4, 2));
    context.font = "20pt Calibri";
    context.textAlign = "center";
    t4 = this._width;
    t5 = $.getInterceptor$n(t4);
    context.fillText("Restart", t5.$div(t4, 2), $.$div$n(this._height, 2), t5.$div(t4, 2));
  },
  get$draw_failure: function() {
    return new $.BoundClosure$0(this, "draw_failure$0");
  },
  draw_success$0: function() {
    ...
    t4 = this._width;
    t5 = $.getInterceptor$n(t4);
    context.fillText("Success", t5.$div(t4, 2), $.$div$n(this._height, 4), t5.$div(t4, 2));
    context.font = "20pt Calibri";
    context.textAlign = "center";
    t4 = this._width;
    t5 = $.getInterceptor$n(t4);
    context.fillText("New Game", t5.$div(t4, 2), $.$div$n(this._height, 2), t5.$div(t4, 2));
  },
  get$draw_success: function() {
    return new $.BoundClosure$0(this, "draw_success$0");
  },
  draw$1: function(_) {
    var t1, t2, context, time, t3, context0, i;
    t1 = this.canvas;
    t2 = $.getInterceptor$x(t1);
    context = t2.get$context2D(t1);
    ...
    if (t3 != null) {
      ...
      if (typeof t3 !== "number")
        throw $.iae(t3);
      $.showFps($.JSDouble_methods.round$0(1000 / t3));
    }
    this.renderTime = time;
    context0 = t2.get$context2D(t1);
    context0.fillStyle = "black";
    context0.fillRect(0, 0, this._width, this._height);
  ...
  Game$1: function(canvas) {
    ...
    t1 = this.canvas;
    t2 = $.getInterceptor$x(t1);
    t2.get$onKeyDown(t1).listen$1(this.get$key_listener());
    t2.get$onMouseMove(t1).listen$1(this.get$mouse_movement());
    t2.get$onMouseDown(t1).listen$1(this.get$mouse_press());
    t2.get$onMouseUp(t1).listen$1(this.get$mouse_release());
    this.init_var$0();
  }
};

$$.Cell = {"": "Object;x>,y>,body_size<",
  draw$1: function(context) {
    var t1, t2, t3;
    if ($.$lt$n($.$add$ns(this.x, this.body_size), 0) || $.$ge$n($.$sub$n(this.x, this.body_size), context.canvas.width))
      return;
    if ($.$lt$n($.$add$ns(this.y, this.body_size), 0) || $.$ge$n($.$sub$n(this.y, this.body_size), context.canvas.height))
      return;
    t1 = $.$mul$n(this.x, this.body_size);
    t2 = $.$mul$n(this.y, this.body_size);
    t3 = this.body_size;
    context.clearRect(t1, t2, t3, t3);
  },
  equal$1: function(other) {
    var t1 = $.getInterceptor$x(other);
    if ($.$eq(this.x, t1.get$x(other)) === true && $.$eq(this.y, t1.get$y(other)) === true)
      return true;
    return false;
  },
  toString$0: function(_) {
    return $.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add($.JSString_methods.$add("(", $.toString$0(this.x)), ","), $.toString$0(this.y)), ")");
  },
  Cell$nextPosition$2: function(current, direction) {
    var t1;
    this.body_size = current.get$body_size();
    switch (direction) {
      case "North":
        t1 = $.getInterceptor$x(current);
        this.x = t1.get$x(current);
        this.y = $.$sub$n(t1.get$y(current), 1);
        break;
      case "South":
        t1 = $.getInterceptor$x(current);
        this.x = t1.get$x(current);
        this.y = $.$add$ns(t1.get$y(current), 1);
        break;
      case "East":
        t1 = $.getInterceptor$x(current);
        this.x = $.$add$ns(t1.get$x(current), 1);
        this.y = t1.get$y(current);
        break;
      case "West":
        t1 = $.getInterceptor$x(current);
        this.x = $.$sub$n(t1.get$x(current), 1);
        this.y = t1.get$y(current);
        break;
    }
  }
...
$$.Food = {"": "Object;x>,y>,body_size<",
  ...
  draw$1: function(context) {
    ...
    if (typeof t2 !== "number")
      throw $.iae(t2);
    if (t1 + t2 < 0 || $.JSNumber_methods.$ge(t1 - t2, context.canvas.width))
      return;
    t1 = this.y;
    if (t1 + t2 < 0 || $.JSNumber_methods.$ge(t1 - t2, context.canvas.height))
      return;
    context.save();
    context.beginPath();
    t1 = this.x;
    ...
    if (typeof t2 !== "number")
      throw $.iae(t2);
    context.arc(t1 * t2 + t2 / 2, this.y * t2 + t2 / 2, t2 / 2, 0, 6.283185307179586, false);
    context.closePath();
    context.clip();
    t2 = this.x;
    t1 = this.body_size;
    if (typeof t1 !== "number")
      throw $.iae(t1);
    context.clearRect(t2 * t1, this.y * t1, t1, t1);
    context.restore();
  }
};
...
$.main = function() {
  var canvas, centipede, context;
  canvas = document.querySelector("#myCanvas");
  canvas.focus();
  centipede = $.Game$(canvas);
  context = $.get$context2D$x(centipede.canvas);
  context.fillStyle = "black";
  context.fillRect(0, 0, centipede._width, centipede._height);
  centipede.step$0(centipede);
  $.Window_methods.requestAnimationFrame$1(window, centipede.get$draw());
};
...
$.showFps = function(fps) {
  ...
  document.querySelector("#notes").textContent = $.S($.JSNumber_methods.toInt$0($.round$0$nx($.fpsAverage))) + " fps";
};

$.Game$ = function(canvas) {
  var t1 = new $.Game(canvas, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
  t1.Game$1(canvas);
  return t1;
};

$.Cell$ = function(x, y, body_size) {
  return new $.Cell(x, y, body_size);
};

$.Cell$nextPosition = function(current, direction) {
  var t1 = new $.Cell(null, null, null);
  t1.Cell$nextPosition$2(current, direction);
  return t1;
};

$.Food$ = function(x, y, body_size) {
  return new $.Food(x, y, body_size);
};
